-- Drop the table first if it already exists (optional, for testing)
...
(7, 'Stonehenge', 'Stonehenge is a prehistoric monument in the middle of a vast plain in the southern part of Britain. The monument itself consists of gigantic stone blocks arranged in overlapping circles.', 'https://www.melivecode.com/attractions/7.jpg', 51.1788853, -1.8284037),
(8, 'Statue of Liberty', 'The Statue of Liberty is a colossal neoclassical sculpture on Liberty Island in New York Harbor in New York City, United States. The statue was a gift from the people of France.', 'https://www.melivecode.com/attractions/8.jpg', 40.689167, -74.044444),
(9, 'Sydney Opera House', 'The Sydney Opera House is a multi-venue performing arts centre in Sydney. Located on the banks of the Sydney Harbour, it is one of the most famous and distinctive buildings in the world.', 'https://www.melivecode.com/attractions/9.jpg', -33.858611, 151.214167),
(10, 'Great Pyramid of Giza', 'The Great Pyramid of Giza is the oldest and largest of the pyramids in the Giza pyramid complex bordering present-day Giza in Greater Cairo, Egypt.', 'https://www.melivecode.com/attractions/10.jpg', 29.979167, 31.134167),
(11, 'Hollywood Sign', 'The Hollywood Sign is an American landmark and cultural icon overlooking Hollywood, Los Angeles, California. It is situated on Mount Lee.', 'https://www.melivecode.com/attractions/11.jpg', 34.134061, -118.321592),
(12, 'Wat Phra Kaew', 'Wat Phra Kaew, commonly known as the Temple of the Emerald Buddha, is regarded as the most sacred Buddhist temple in Thailand.', 'https://www.melivecode.com/attractions/12.jpg', 13.751389, 100.4925),
...
(15, 'Great Barrier Reef', 'The Great Barrier Reef is the world’s largest coral reef system located in the Coral Sea, off the coast of Queensland, Australia. It is home to thousands of marine species.', 'https://images.unsplash.com/photo-1582967788606-a171c1080cb0', -18.2870668, 147.6991918);

-- Set the next auto increment value correctly
ALTER TABLE `attraction` AUTO_INCREMENT = 16;
